    ...
    update : func {
        ...
        if (getprop("services/payload/catering-loading") == 1) {
            ...
            if (prepgalleytotal > 0) {
                if ((getprop("services/catering/position1") + getprop("services/catering/position2") + getprop("services/catering/position3")) < 3) {
                ...
                if ((getprop("services/payload/baggage-loading") == 0) or (getprop("services/payload/belly-request-lbs") == 0)) {
                    ...
                    if ((((getprop("services/payload/belly-request-lbs") - getprop("services/payload/belly-onboard-lbs")) / (150 * (getprop("services/payload/baggage-truck1-enable") + getprop("services/payload/baggage-truck2-enable")))) / (prepgalley1trolley + prepgalley2trolley + prepgalley3trolley)) < 4) {
                        setprop("services/payload/catering-skipcycle-nr", 3);
                    } else {
                        setprop("services/payload/catering-skipcycle-nr", ((getprop("services/payload/belly-request-lbs") - getprop("services/payload/belly-onboard-lbs")) / (150 * (getprop("services/payload/baggage-truck1-enable") + getprop("services/payload/baggage-truck2-enable")))) / (prepgalley1trolley + prepgalley2trolley + prepgalley3trolley));
                ...
                setprop("services/payload/catering-loading", 3);
            }			
            ...
            if (getprop("services/payload/catering-request-lbs") > getprop("services/payload/catering-onboard-lbs")) {
                if ((getprop("services/catering/position1") == 1) and ((getprop("services/payload/catering-cycle-nr") / getprop("services/payload/catering-skipcycle-nr")) == math.round(getprop("services/payload/catering-cycle-nr") / getprop("services/payload/catering-skipcycle-nr")))) {
                    if ((getprop("sim/weight[2]/weight-lb") + getprop("services/payload/catering-trolley-lbs")) < getprop("sim/weight[2]/max-lb")) {
                        ...
                        if ((getprop("services/payload/catering-galley-1-full") + getprop("services/payload/catering-galley-2-full") + getprop("services/payload/catering-galley-3-full")) == 3) {
